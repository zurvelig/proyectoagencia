        ...
        <html lang="en">
          ...
          <body id="page-top">
              ...
              <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                  <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                      <a class="nav-link js-scroll-trigger" href="http://127.0.0.1:8000/registroViaje">Gestionar Viaje</a>
                    </li>
            ...
            <form action= "{{url('/registroViajero')}}" method="POST" id="formulario" enctype="multipart/form-data">
                ...
                <div class="container">
                  <div class="row">
                   <div class="col-lg-12 text-center">
                          <h2 class="section-heading">Gestionar Viajero</h2>
                          <hr class="my-4">
                              ...
                              <div class="panel panel-default">
                                <div class="panel-body">
                                  ...
                                  <div class="table-container">
                                     <a class="btn btn-primary btn-xs js-scroll-trigger" href="#registrar">Agregar Viajero</a> <br><br>
                                    <table id="mytable" class="table table-bordred table-striped">
                                     ...
                                     <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                           <a class="btn btn-info btn-xs" href="{{ action('ControladorViajero@edit', [$viajero->id]) }}">Editar</a>
                                         </td>
          ...
          <form action= "{{url('/registroViajero')}}" method="POST" id="formulario">
                {{csrf_field()}} <!-- se usa para enviar un formulario correctamente, debe incluir una entrada de token CSRF -->
              ...
              <div class="row">
                ...
                <div class="col-lg-3 col-md-6 text-center">
                  <div class="service-box mt-5 mx-auto">
                    ...
                    <h3 class="mb-3">Registrar Viajero</h3>
                ...
                <div class="col-lg-3 col-md-6 text-center">
                  <div class="service-box mt-5 mx-auto">
                    ...
                    <!-- fin msj -->
                        ...
                        <input type="text" name="direccion" class="form-control" placeholder="Dirección" value="{{ old('direccion') }}" required autofocus><br>
                        <div>
                  ...
                  <div class="col-lg-3 col-md-6 text-center">
                    <div class="service-box mt-5 mx-auto">
                      ...
                      <input type="text" name="nombre" class="form-control" placeholder="Nombre" value="{{ old('nombre') }}" required autofocus><br>
                      <div>
